          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-app-text">
                {t("appointmentForm.newTitle")}
              </h1>
              <p className="mt-2 text-app-muted">
                {t("appointmentForm.newDescription")}
              </p>
            </div>
        ...
        <div className="rounded-2xl border border-app-soft bg-app-card p-6 shadow-sm">
          <NewAppointmentForm
            ...
            labels={{
              ...
              saveAppointment: t("appointmentForm.saveAppointment"),
              ...
              employeeAutoSelected: t("appointmentForm.employeeAutoSelected"),
              roomAutoSelected: t("appointmentForm.roomAutoSelected"),
